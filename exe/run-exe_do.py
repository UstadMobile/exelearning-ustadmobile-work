...
if os.name == 'posix' and '--standalone' not in sys.argv:
...
from <input_file> elp package").encode(sys.stdout.encoding))
    ...
    parser.add_option("-x", "--export",
                  ...
                  choices=['xml', 'scorm12', 'scorm2004', 'agrega',
                           'ims', 'website', 'webzip', 'singlepage',
                           'xliff', 'epub3', 'ustadmobile'],
    ...
    if options.set_options:
        try:
            ...
            for set_option in set_options:
                ...
                if(prop_type == bool):
                    print("Property of current set option is boolean!")
                    if(value == "False"):
                        print("Boolean value set to False");
                        value = False
                    else:
                        print("Boolean value set to True");
                        value = True 
                else:
