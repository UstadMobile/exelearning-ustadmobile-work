...
"""
The IDevicePage is responsible for managing eXe idevice popup
"""
...
class IDevicePage(RenderableResource):
    """
    """
    name = 'idevicep'
    ...
    def render_GET(self, request):
        ...
        try:
            ...
            data['showIDevicePageOnStart'] = self.config.showIDevicePageOnStart
        except Exception as e:
            log.exception(e)
            return json.dumps({'success': False, 'errorMessage': _("Failed to get idevicep edit")})
    ...
    def render_POST(self, request):
        ...
        try:
            ...
            showIDevicePageOnStart = request.args['showIDevicePageOnStart'][0]
            self.config.showIDevicePageOnStart = showIDevicePageOnStart
            self.config.configParser.set('user', 'showIDevicePageOnStart', showIDevicePageOnStart)
        except Exception as e:
            log.exception(e)
            return json.dumps({'success': False, 'errorMessage': _("Failed to save preferences idevicep")})
