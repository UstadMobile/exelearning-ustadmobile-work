...
"""
The WizardPage is responsible for managing eXe wizard
"""
...
class WizardPage(RenderableResource):
    """
    The WizardPage is responsible for managing eXe preferences, wizard
    """
    name = 'wizard'
    ...
    def render_GET(self, request):
        ...
        try:
            ...
            data['showWizardOnStart'] = self.config.showWizardOnStart
        except Exception as e:
            log.exception(e)
            return json.dumps({'success': False, 'errorMessage': _("Failed to get preferences wizard edit")})
